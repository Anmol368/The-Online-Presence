...
import ShapeImg from "../../../public/images/v1/down-arrow2.svg";
			...
			<FadeInStaggerTwoChildren>
				<p>
					{`We're a creative design studio specializing in meeting the needs of the new generation.
								We offer innovative and cutting-edge design solutions to help our clients stand out in todays fast-paced world.`}
				</p>
			</FadeInStaggerTwoChildren>
			<FadeInStaggerTwoChildren>
