			...
			<div className="container">
				...
				<FadeInUp className="accordion aximo-accordion-wrap" id="aximo-accordion">
					...
					<div className="accordion-item">
						...
						>
							<div className="accordion-body">
								Yes, we&apos;re proud to showcase a portfolio of our previous projects. You can find
								examples of our work on our website or request a tailored portfolio relevant to your
								needs. Clients often want to see examples of the agency&apos;s previous projects to
					...
					<div className="accordion-item">
						...
						<div id="collapseSix" className="accordion-collapse collapse" data-bs-parent="#aximo-accordion">
							<div className="accordion-body">
								...
								urgent projects, so it&apos;s important to communicate if the agency can accommodate
								rush orders.
							</div>
						</div>
					</div>
